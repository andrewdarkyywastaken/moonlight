if type(script_key)~="string"or #script_key~=32 then
	return messagebox("Copy the entire script that was provided to you by the Luarmor bot. Ensure that it consists of precisely 2 lines of code.","Moonlight",0x00000030+0x00010000);
end;
